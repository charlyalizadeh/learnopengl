...
// Resize the viewport after the window is resized
...
int main() {
    // Init GLFW and configure it to use OpenGL version 3.3
    // and explicitly use the core-profile
    glfwInit();
    ...
    // Generate an OpenGL vertex array
    unsigned int VAO;
    ...
    while(!glfwWindowShouldClose(window))
    {
        ...
        // We use the shader pipeline we created
        glUseProgram(shaderProgram);

        // We bind the Vertex array to
        glBindVertexArray(VAO);
